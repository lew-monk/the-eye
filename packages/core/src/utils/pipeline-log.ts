...
export const PipelineStage = {
	...
	OCR_HYBRID_STARTED: 'ocr_hybrid_started',
	OCR_HYBRID_NATIVE_DONE: 'ocr_hybrid_native_done',
	OCR_HYBRID_OCR_PAGES: 'ocr_hybrid_ocr_pages',
	OCR_HYBRID_FALLBACK: 'ocr_hybrid_fallback',
